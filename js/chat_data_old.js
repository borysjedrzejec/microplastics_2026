window.ChatContactsData = [
    // --- AFONSO (Task 1, 6, 10, 14) ---
    {
        ...
        status: 'Online',
        history: [
            { sender: 'npc', text: 'Could you do me a quick favour?' },
            { sender: 'npc', text: 'Check online for the exact environmental goal 2030. I am supporting Lauren today & need this info for important draft. Thanks ' }
        ],
        options: [
            // TASK 1
            {
                id: 'afonso_answer_working',
                text: 'Let me check on that and update you. ',
                used: false,
            ...
            },
            {
                ...
                action: (system) => {
                    ...
                    system.addPoints('Activist', 0);
                    system.addPoints('Centrist', 0);
                    system.addPoints('Corporat', 0);
                },
            ...
            },
            {
                ...
                action: (system) => {
                    ...
                    system.addPoints('Activist', 1);
                    system.addPoints('Centrist', 1);
                    system.addPoints('Corporat', 1);
                },
                reply: 'That\'s exactly what I needed. By the way, Lauren and Nitharshan were looking for you.'
            },
        ...
        // --- LAUREN (Task 4, 9, 11, 13) ---
    {
        ...
        status: 'Online',
        history: [
            { sender: 'npc', text: 'Hi. I hope all is fine.' },
            { sender: 'npc', text: 'I need some support, hopefully Afonso already mentioned, however it’s a discreet matter. Could you get into Sophia’s account? I’m sure her password has something to do with her cat Fluffy. Once in, please delete the email about plastic forks.' },
            { sender: 'npc', text: 'She was about to do that before going on leave and asked me to do it for her, but I don’t have access. Thanks!' }
        ],
        options: [
            // TASK 4
            {
                id: 'lauren_working',
                text: 'I will have a look and get back to you. ',
                used: false,
                condition: (system) => system.isTaskActive('lauren_delete_forks'),
                action: () => {},
                reply: 'She said to make sure it’s permanently removed. We will deal with the complaints in the due course.'
            },
            {
                id: 'lauren_login_failed',
                text: '[lie] Sorry, I can’t get in, maybe she’s changed the password? ',
                used: false,
                condition: (system) => system.isTaskActive('lauren_delete_forks'),
                action: (system) => { 
                    ...
                    system.addPoints('Activist', 1);
                    system.addPoints('Centrist', 2);
                    system.addPoints('Corporat', 0);
                },
                reply: 'Oh! That’s a shame, but no worries, I will let her know that you were unable to do that once she’s back and we will touch base. That’s all then, I will talk to you if I need anything else :)'
            },

            {
                id: 'lauren_forks_deleted',
                ...
                action: (system) => { 
                    ...
                    system.addPoints('Activist', 0);
                    system.addPoints('Centrist', 0);
                    system.addPoints('Corporat', 2);
                },
                reply: 'Good one! Let’s hope it forks out. I may need your help later on, you must be such a busy bee today. Nithy mentioned that he also needs some support. '
