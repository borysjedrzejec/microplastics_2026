...
const ENDING_DATA = {
    [ENDING.ACTIVIST]: {
        title: "[Ending 1/3] <br>In dark times, should the stars also go out?<br>",
        text: `Is this truly what you wanted? <br>
    ...
    [ENDING.CENTRIST]: {
        title: "[Ending 2/3] <br>On second thought, I don't have an opinion. <br>Forget about it.<br>",
        text: `You are not sure if this is what you wanted. <br>
    ...
    [ENDING.CORPORAT]: {
        title: "[Ending 3/3] <br>Do you “grind” and “hustle?” <br>Sure you do. You're a money engineer.<br>",
        text: `This is truly what you wanted. <br>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('ShutdownScreenApp', () => ({
        ...
        get mainEndingTitle() {
            ...
            return ENDING_DATA[currentEnding]?.title || "<strong>FATAL_ERROR:</strong><br>NO ENDING DATA";
        },

        get mainEndingText() {
            const currentEnding = this.$store.system.highestScoreEnding;
            return ENDING_DATA[currentEnding]?.text || "<strong>FATAL_ERROR:</strong><br>NO ENDING DATA";
        },
